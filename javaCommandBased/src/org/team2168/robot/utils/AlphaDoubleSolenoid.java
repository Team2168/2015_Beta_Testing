 ...
 */
public class AlphaDoubleSolenoid extends SolenoidBase implements LiveWindowSendable {
    ...
    private static Solenoid s1;
    private static Solenoid s2;
...
//        LiveWindow.addActuator("DoubleSolenoid", m_moduleNumber, m_forwardChannel, this);
     ...
     */
    public AlphaDoubleSolenoid(final int forwardChannel, final int reverseChannel) {
        super(getDefaultSolenoidModule());
        //m_forwardChannel = forwardChannel;
        //m_reverseChannel = reverseChannel;
        s1 = new Solenoid(forwardChannel);
        s2 = new Solenoid(reverseChannel);
        initSolenoid();
    }
     ...
     * @param reverseChannel The reverse channel on the module to control.
     */
    public AlphaDoubleSolenoid(final int moduleNumber, final int forwardChannel, final int reverseChannel) {
        super(moduleNumber);
        m_forwardChannel = forwardChannel;
        m_reverseChannel = reverseChannel;
        initSolenoid();
